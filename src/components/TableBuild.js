...
const links = {
  "AWS Speech Analytics":
    "https://aws.amazon.com/solutions/ai-powered-speech-analytics-for-amazon-connect/?trk=sl_card",
  "Azure Speech Services":
    "https://azure.microsoft.com/en-ca/services/cognitive-services/speech-services/",
  "Google Cloud Speech to Text": "https://cloud.google.com/speech-to-text/",
  "AWS Fraud Detection":
    "https://aws.amazon.com/solutions/fraud-detection-using-machine-learning/",
  "Azure Advanced Threat Detection":
    "https://azure.microsoft.com/en-ca/features/azure-advanced-threat-protection/",
...
const rows = [
  createData(
    ...
    <button
      ...
      data-for="global"
      onClick={() => {
        window.open(links["AWS Speech Analytics"], "_blank");
      }}
    >
      <b>AWS Speech Analytics</b>
    </button>,
    <button
      className="button button__accent"
      data-tip
      data-for="global"
      onClick={() => {
        window.open(links["Azure Speech Services"], "_blank");
      }}
    >
      <b>Azure Speech Services</b>
    </button>,
    <button
      className="button button__accent"
      data-tip
      data-for="global"
      onClick={() => {
        window.open(links["Google Cloud Speech to Text"], "_blank");
      }}
    >
      <b>Google Cloud Speech to Text</b>
    </button>
  ),
  ...
  createData(
    ...
    <button
      ...
      data-for="global"
      onClick={() => {
        window.open(links["AWS Fraud Detection"], "_blank");
      }}
    >
      <b>AWS Fraud Detection</b>
    </button>,
    <Link
      className="button button__accent"
      data-tip
      data-for="global"
      onClick={() => {
        window.open(links["Azure Advanced Threat Detection"], "_blank");
      }}
    >
      <b>Azure Advanced Threat Detection</b>
    </Link>,
    <Link
      className="button button__accent"
      data-tip
      data-for="global"
      onClick={() => {
        window.open(links["Google Cloud Event Threat Detection"], "_blank");
      }}
    >
      <b>Google Cloud Event Threat Detection</b>
    </Link>
  )
